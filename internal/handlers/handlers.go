...
import (
	...
	"github.com/Leo-Mart/bookings/internal/forms"
	...
	"github.com/Leo-Mart/bookings/internal/repository"
	"github.com/Leo-Mart/bookings/internal/repository/dbrepo"
...
// Reservation render the make a reservation page and displays form
...
// Generals render Generals room page
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "generals.page.tmpl", &models.TemplateData{})
}

// Majors render the Majors room page
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "majors.page.tmpl", &models.TemplateData{})
}

// Availability render the make a reservation page and displays form
func (m *Repository) Availability(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "search-availability.page.tmpl", &models.TemplateData{})
}

// PostAvailability render the make a reservation page and displays form
...
// AvailabilityJSON handles request for availabilty and send JSON response
...
// BookRoom takes URL parameters, builds a sessional variable, and takes user to makes res screen
...
// AdminShowReservation shows the reservation in the admintool
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	// gett the first and last days of the month
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// that does not exist in our psted data, anf if the restriction id is > 0, then it is a block we need to remove
		curMap := m.App.Session.Get(r.Context(), fmt.Sprintf("block_map_%d", x.ID)).(map[string]int)
		for name, value := range curMap {
			// ok will ne false if the value is not in the map
			if val, ok := curMap[name]; ok {
				// only pay attention to values > 0, and that are not in the form post
				// the rest are just placeholders for dayt without blocks
				if val > 0 {
